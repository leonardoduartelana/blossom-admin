...
import RsClassModel from "../../api/data/RsClassModel";

// ----------------------------------------------------------------------

export default function EmployeeClassesModelCard({classModel, employee}) {

    const router = useRouter();

    const cardBackgroundUrl = classModel.pictureUrl ? classModel.pictureUrl : "https://blossom-public.s3.ap-southeast-2.amazonaws.com/classes/Group-class.jpg"
    const totalDuration = classModel.preDuration + classModel.duration + classModel.postDuration
    const capacity = classModel.capacity ? classModel.capacity : 1
    const credits = classModel.creditPrice
...
EmployeeClassesModelCard.propTypes = {
    classModel: PropTypes.objectOf(RsClassModel),
